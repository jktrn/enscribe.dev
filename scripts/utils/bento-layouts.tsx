export const lgLayout = [
    ...
    { i: 'image-2', x: 0, y: 3, w: 1, h: 2 },
    { i: 'wakatime', x: 1, y: 3, w: 1, h: 1 },
    { i: 'twitter', x: 2, y: 3, w: 1, h: 1 },
    { i: 'spotify', x: 3, y: 3, w: 1, h: 1 },
    { i: 'tech', x: 1, y: 4, w: 1, h: 1 },
    { i: 'contributions', x: 2, y: 4, w: 2, h: 1 },
]
...
export const mdLayout = [
    ...
    { i: 'github', x: 2, y: 0, w: 1, h: 1 },
    { i: 'image-1', x: 3, y: 0, w: 1, h: 2 },
    { i: 'image-2', x: 0, y: 1, w: 1, h: 2 },
    { i: 'discord', x: 1, y: 1, w: 2, h: 1 },
    { i: 'latest-post', x: 2, y: 2, w: 2, h: 1 },
    { i: 'twitter', x: 1, y: 2, w: 1, h: 1 },
    { i: 'spotify', x: 0, y: 3, w: 2, h: 1 },
    { i: 'wakatime', x: 2, y: 3, w: 1, h: 1 },
    { i: 'tech', x: 3, y: 3, w: 1, h: 1 },
    { i: 'contributions', x: 0, y: 4, w: 2, h: 1 },
]
...
export const smLayout = [
    ...
    { i: 'wakatime', x: 1, y: 8, w: 1, h: 1, static: true },
