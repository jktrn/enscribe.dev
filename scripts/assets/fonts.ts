...
const webFonts = [
  ...
  },
  {
    ...
    key: "src/assets/fonts/MDLorienSC-Regular.woff2",
  ...
  },
  {
    ...
    key: "src/assets/fonts/MDLorienSC-Italic.woff2",
...
const graphicsFonts = [
  {
    localPath: `${assetPaths.graphicsFonts}/MDLorien-Regular.otf`,
    key: "graphics/fonts/MDLorien-Regular.otf",
    sha256: "18b6c8872dc6ad430479421bf72ca519f4dd664410ee5d52b1db45c7b8218624",
    size: 257_200,
  },
  {
    localPath: `${assetPaths.graphicsFonts}/MDLorien-Italic.otf`,
    key: "graphics/fonts/MDLorien-Italic.otf",
...
export const graphicsFontAssets = asPrivateAssets(graphicsFonts)
...
if (import.meta.main) {
  ...
  if (mode === "prepare") {
    ...
    throw new Error("Usage: fonts.ts <prepare|prepare-graphics|upload|verify>")
  }
}
