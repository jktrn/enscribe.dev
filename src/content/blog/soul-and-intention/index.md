...
I can only write blog posts on airplanes now. I apologize since meta writing is cringe and I’m meta-meta writing because I’m talking about it, but I’m at an endgame where I must resist all urges to buy on-board Viasat. Otherwise, I surrender myself, bend over and get consensually brainfucked by Anthropic’s latest silicon incarnation of Jesus. It’s like that one GIF of the plug getting inserted into a floor socket in Patrick’s head and all the cogs start turning.[^cogs] Literally me right now.
...
I admit that I did eventually cave in and buy Viasat, but unfortunately Unitedwifi.com shat itself.[^united] Why did the company book me so far back in the plane? So stingy.

[^united]: ![Fuck united](assets/fuck-united.png)


## Pre-AP-calculus

Today I want to write about “taste”. Invoking this word surfaces a gross and bourgeois persona within me that I did not know I had, but unfortunately it communicates my point the clearest as the buzzword du jour. I work a lot with my taste as part of this line of work, and lately it’s the only component of my brain that activates whenever meaningful work must get done. The rest has lain dormant since I started using LLMs on a daily basis. As such, my taste is now the final moat[^moat] between me and brain-atrophying AI psychosis.
...
My job doesn’t feel like anything special to me. I am an aesthetician but for chopped websites instead of chopped nepo babies. Where is my value in all of this?

I started making websites pretty to create a space for myself on the internet. As a 15-year-old there was an aura to having a link in your Discord bio that was entirely custom, entirely yours. I would play in CTF events and make writeups for them, but I had a tendency to gravitate towards stylizing the presentation of the content rather than perfecting the content itself. Since I also felt a strong urge to make pretty graphics to accompany my work (in an earnest attempt to make it more pedagogical) I started using the shape tool on Google Slides[^tools] to draw the little bean guys[^bean] you see everywhere on this site.

[^tools]: I tended to use really shitty tooling. Since I of course wanted to be a YouTuber growing up, I would edit my videos with Microsoft Movie Maker.
...
We’re now post-AP Calculus and I’m 20 IQ points lower. A client asks for some bullshit and my instant gratification monkey goes to spin the wheel at the clanker dispensary. It writes me the landing. Wow, this looks like shit (WTLLS).

### WTLLS factor

I believe that the ability to WTLLS is now the most important skill to have post-AP Calculus. To explain:
...
:::recall[Do you remember what I'm talking about?]
As a recap, I've discussed:
- Plausible implementations of ideas are now cheap, and we are in an era of abundance in output. We now need judgement to determine what should exist in the first place.
- We've defined taste as an accumulation of "micro-decisions" in your input and output. Developing your taste is very hard and very implicit.
- It is really hard to resist the urge to outsource these micro-decisions to a clanker. I've fallen into this trap so many times that now I must physically prevent myself from doing it.[^super]
...
It is accepted and common knowledge that AI has separated the ability to produce a technical object from the ability to understand it (you can now develop faster than the speed of understanding). This is mostly a miracle and has made creating things more accessible. We've somehow democratized technicalness!

I've observed that there are two emerging social circles, whose identities depend on how they rationalize the usage of AI: the non-technical technical club (NTTC) and the anti-clanker clanker club (ACCC). I'm quite proud of this naming because you can tell they have their internal contradictions and dilemmas.
...
The ACCC's primary issue is that they hate the clankers they cannot stop using. I am the president and founding member of this club.

Although both NTTC and ACCC members want credit for clanked intelligence, an ACCC member is a bit more subtle; they'd prefer it if nobody knew a clanker was utilized in the first place. Members mask their clanking by euphemizing it as something mechanically unimportant: "oh, it helped me brainstorm," "it sped up my workflow," "it removed tedium." They are aware that owning up to the clanker's contribution would weaken their claim to authorship, and so they sanitize the result. They feel ashamed that the clanker is doing technical work that they couldn't do themselves.[^technical]
...
When I was scrolling Instagram Reels[^reels] prior to entering the plane, I actually encountered [this Reel](https://www.instagram.com/reels/DcE5zejqxrT/) that talked about how children's [jungle gyms](https://en.wikipedia.org/wiki/Jungle_gym) have been trending towards being too cushy and safe over the past decade. "This (a crazy and tall metal jungle gym) is not good because kids can die, but this (a moderately normal jungle gym) is good because kids can get hurt," the presenter said. Apparently this is an entire [culture war](https://cps.ca/en/documents/position/outdoor-risky-play), and proponents of "risky play" have differentiated between "risks" and "hazards" within the playground environment.
...
I never really liked any of the jungle-gymmy parts of playgrounds. I grew up going to [Thornburg Park](https://maps.app.goo.gl/BBSbUmfEFEXhDoe99) and playing at [this particular playground](https://maps.app.goo.gl/rEfATpZdyBsf2djD7)[^playground] after Vietnamese school on Sundays. I didn't like the (literal) friction of going down that fireman's pole and how it felt on my fingers. I also didn't like playing on the swings because they were always kinda dirty and the playground sand had a lot of these weird bugs flying around. I probably also had a lunch I disliked because the Sunday school people always served wonky vegetarian food I didn't like at the time. Overall it was just quite an unpleasant experience, and so I often opted out and just sat near the shade of the pagoda playing with blades of grass.
...
### Autotelicity: "for the love of the game"

In college, I was super hardstuck Ascendant 1 in Valorant. I would duo until 3am with my buddy and always hop off on a loss with net negative RR and just think it was the end of the world. I would blame my games on crypto wintraders or cheaters or the bottom frag or any combination of the three (unless I was myself the bottom frag). It was such a bit that I now have an Ascendant buddy on my car keys.[^keys]
...
You can probably see where this is going. I began designing autotelically, my identity changed, and now the original activity I loved has become muddled with extrinsic goals. When the client requests "some bullshit," the real objective is now simply possessing a landing page. Of course the clanker would become irresistible; when the artifact is the reward, why would you take the hard way when you can take the easy way? You'd be crazy otherwise.

As such:

- You don't need discipline to perform an autotelic activity because performing it is what you wanted. If the goal was to simply reach the end platform, then the teleporter wins. The teleporter only fails when your entire reward comes from swinging on the monkey bars. You also cannot discipline yourself into autotelicity.
- If you force yourself to "love the process" because you want to preserve your skills, the preservation itself is still serving an external goal.

### Wanting to want

Wanting to love an activity is not the same thing as actually loving it. If I have to repeatedly make that virtuous choice to remind myself that designing is supposed to be fun, I am trying to masquerade discipline as an intrinsic motivator. I wish that I could just turn it on like a switch since this Korean Overwatch coach told me to, but unfortunately this isn't the case. With Valorant, I discovered I loved the results more than I loved the game, and as a result I never ended up climbing past Ascendant I.

I definitely still have this autotelicity within me. I feel it whenever I touch this website. I love doing this so much it's incomprehensible. Fifteen-year-old me was not decorating websites because there was a thriving market for pedagogically-adorned cybersecurity blogs.
