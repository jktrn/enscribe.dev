...
image: 'assets/beginners-compilation/banner.webp'
authors: ['enscribe']
---

import Challenge from '@/components/mdx/Challenge.astro'
import InfoBox from '@/components/mdx/InfoBox.astro'
import MorseAudio from './assets/beginners-compilation/morse_chal.wav'
...
![Google CVE](assets/beginners-compilation/cve-google.png)
...
![Automatic Morse Decoding](assets/beginners-compilation/morse-code.gif)
...
>
  ...
  <figure>
    <div class="max-w-72 mx-auto [&_img]:mb-0">![drawing.flag.svg](assets/beginners-compilation/svg.png)</div>
...
![SVG Code](assets/beginners-compilation/svg2.png)
