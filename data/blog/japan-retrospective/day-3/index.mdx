...
<div className="tocr">
    <TOCInline toc={
        [
            { value: 'Day 0: Arrival at KIX', url: '/blog/japan-retrospective/day-0', depth: 1 },
            { value: 'Day 1: Osaka Day Trip', url: '/blog/japan-retrospective/day-1', depth: 1 },
            { value: 'Day 2: Nara Day Trip', url: '/blog/japan-retrospective/day-2', depth: 1 },
            { value: 'Day 3: East Kyoto', url: '/blog/japan-retrospective/day-3', depth: 1, active: true }
        ]
    } title="Daily Log" />
</div>
...
From here, we returned to our apartment and took a fat nap.