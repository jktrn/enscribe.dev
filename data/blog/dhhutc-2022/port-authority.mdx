...
<div className="flex justify-center align-center gap-0 flex-col md:gap-4 md:flex-row">
    <CodeBlock
...
<CodeBlock
    ...
    scrollable={true}
    range={[[80, 120]]}
    addedLines={[[80, 80], [96, 96], [99, 100], [103, 104], [107, 108], [111, 112], [115, 116], [119, 119]]}
/>
...
<div className="flex justify-center align-center gap-0 flex-col md:gap-4 md:flex-row">
    ![Death 1](/static/images/dhhutc-2022/death1.png)
    ![Death 2](/static/images/dhhutc-2022/death2.png)
</div>
